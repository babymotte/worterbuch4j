...
public class Unsubscribe {
	...
	@JsonPropertyDescription("The transaction ID of the subscription to be cancelled")
	...
	public String toString() {
		...
		sb.append(Unsubscribe.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
				.append('[');
	...
	public boolean equals(final Object other) {
		...
		final var rhs = ((Unsubscribe) other);
