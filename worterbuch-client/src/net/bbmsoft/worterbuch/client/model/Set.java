...
public class Set {
	...
	/**
	 * The key for which to set the value (Required)
	 * 
	 */
	@JsonProperty("key")
	@JsonPropertyDescription("The key for which to set the value")
	private String key;
	/**
	 * The new value for the key (Required)
	 * 
	 */
	@JsonProperty("value")
	@JsonPropertyDescription("The new value for the key")
	...
	public String toString() {
		...
		sb.append(Set.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
				.append('[');
