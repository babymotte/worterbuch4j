...
public class PDelete {
	...
	/**
	 * The deletion pattern (Required)
	 * 
	 */
	@JsonProperty("requestPattern")
	@JsonPropertyDescription("The deletion pattern")
	...
	public String toString() {
		...
		sb.append(PDelete.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
				.append('[');
	...
	public boolean equals(final Object other) {
		...
		if ((other instanceof PDelete) == false) {
			return false;
		}
		final var rhs = ((PDelete) other);
